...
_TOOL_CATALOGUE: list[dict[str, str]] = [
    ...
    {"id": "esg-toolbox",         "label": "ESG toolbox workflow",
     "endpoint": "/api/v1/esg-toolbox",
     "desc": "Recommend ESG modules, minimize inputs, crosswalk metrics, and produce UI-ready evidence cards."},
...
_FIELD_RECIPES: dict[str, list[dict[str, str]]] = {
    ...
    "esg-toolbox":         [{"k": "action", "t": "text", "label": "Action: recommend|workflow|input_plan|search|assess"},
                            {"k": "tool_id", "t": "text", "label": "Module ID (optional for recommend)"},
                            {"k": "query", "t": "text", "label": "Search query"},
                            {"k": "category", "t": "text", "label": "Category: all|disclosure|rating|export|supplier|carbon"},
                            *_COMPANY_FIELDS,
                            {"k": "jurisdiction", "t": "text", "label": "Jurisdiction or market"},
                            {"k": "document_text", "t": "textarea", "label": "Evidence text / data-room extract"},
                            {"k": "product_code", "t": "text", "label": "Product / CN / HS / SKU code"},
                            {"k": "country", "t": "text", "label": "Country or export market"},
                            {"k": "supplier_profile", "t": "textarea", "label": "Supplier / audit profile"},
                            {"k": "output_format", "t": "text", "label": "Output format: json|text"}],
...
function fillSampleData() {
  ...
  const sample = {
    ...
    metric_id: "PI2822",
    format: "json",
    action: ACTIVE_TOOL === "esg-toolbox" ? "recommend" : "add",
    tool_id: "",
    query: "battery export carbon supplier",
    category: "all",
    jurisdiction: "EU",
    document_text: "Acme Solar has Scope 1 and Scope 2 GHG inventory, electricity bills, supplier code of conduct, factory audit records, product SKUs and EU customer requests.",
    product_code: "850760",
    country: "EU",
    supplier_profile: "Tier 1 manufacturing suppliers with audit records, worker policies, CAPA logs and procurement controls.",
    output_format: "json",
