...
_SECTOR_KEYWORDS: dict[str, list[str]] = {
    "Technology & Communications": ["software", "tech", "IT", "SaaS", "cloud", "internet", "digital", "platform", "app", "AI", "data"],
    "Financials": ["bank", "finance", "fintech", "insurance", "asset management", "lending", "credit", "microfinance", "payment"],
    "Health Care": ["health", "medical", "pharma", "biotech", "hospital", "clinic", "drug", "therapeutic", "diagnostics"],
    "Renewable Resources & Alternative Energy": ["solar", "wind", "renewable", "clean energy", "green energy", "biomass", "hydro"],
    "Food & Beverage": ["food", "agriculture", "farming", "beverage", "nutrition", "crop", "livestock", "agri"],
    "Infrastructure": ["real estate", "housing", "construction", "infrastructure", "property", "building"],
    "Extractives & Minerals Processing": ["oil", "gas", "mining", "mineral", "extraction", "fossil"],
    ...
    "Services": ["education", "service", "consulting", "hospitality", "professional service"],
}
