...
PAI_INDICATORS: list[SFDRIndicator] = [
    ...
    SFDRIndicator(
        ...
        iris_cross_refs=["OI9803", "OI1479"],  # Energy consumed; renewable generated
    ...
    SFDRIndicator(
        ...
        iris_cross_refs=["OI4112", "OI9803"],  # Effluent + water proxy
    ...
    SFDRIndicator(
        ...
        iris_cross_refs=["PI3468"],  # Hazardous waste generated
